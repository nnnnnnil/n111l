...
<h3>1. 深圳市良博智能有限公司（短期项目制）</h3>

**时间**：2025 年 01 月 - 2026 年 03 月

**职责**：负责公司im项目的管理后台管理系统开发，以及一些h5页面开发

<h3>2. 深圳市瑞云科技有限公司 - web 前端开发（青椒云部门）（裁员）</h3>

**时间**：2024 年 08 月 - 2025 年 01 月

**职责**：负责青椒云官网维护，经销商管理系统和青椒云客户端迭代开发。

<h3>3. 广州奥凯信息咨询有限公司 - web 前端开发（软件部）</h3>
...
2.  熟练掌握 `react` 和 `next.js` 框架，并能结合其生态进行开发，了解其基本原理。

3.  熟练掌握 `vue2` 和 `vue3` 框架，并能结合其生态进行开发，了解其基本原理。

4.  熟悉微信小程序，taro框架。

5.  熟悉node框架nest.js，docker容器技术

<h2>四、项目经历</h2>

<h3>1. 管理系统 (良博)</h3>

**时间**：2025 年 10 月 - 2026 年 01 月

**介绍**：该项目是公司移动端im项目的管理系统

**负责**：我负责系统的从0到1的搭建，项目的90%页面由自己编写

**亮点**：项目支持主题换肤，暗黑模式，多语言切换； 实现动态路由， 支持白名单，并在热更新时不丢失路由数据；封装`CustomForm`组件，支持按配置渲染表单；封装`fetch`请求，结合`useMutation`封装成`useFetch hook`；封装`usePermission`、`useFullscreen`等hooks

**技术**：`react+antd+tailwind css+tanStack query+zustand`
